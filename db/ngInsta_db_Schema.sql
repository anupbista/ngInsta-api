...
for each row begin
	CALL removeFollowStatus(old.userId, old.aliasId);
end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
for each row begin
	update posts set likesNo = likesNo +1 where id = new.postId;
end */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `removeFollowStatus`(userId CHAR(36), aliasId CHAR(36))
BEGIN
	update users set following = following -1 where id = userId;
    update users set followers = followers -1 where id = aliasId;
END ;;
...
-- Dump completed on 2019-06-27  0:39:47
